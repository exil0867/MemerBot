...
const captionGenerator = (buffer, dirPath, ext, captionText) => {
  return new Promise(async (resolve, reject) => {
    ...
    function generate(inputPath) {
      ...
      imagemagickCli.exec(`convert -background white -interline-spacing 0 -kerning 0 -fill black  -font "./caption-font.otf" -pointsize 34 -size ${imageSize.width}x -gravity Center  caption:"${captionText}" PNG24:${captionPath}`)
        .then(() => {
